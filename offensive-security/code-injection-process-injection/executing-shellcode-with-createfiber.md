...
{% embed url="https://docs.microsoft.com/en-us/windows/win32/procthread/fibers" caption="" %}

{% embed url="https://nullprogram.com/blog/2019/03/28/" caption="" %}

{% embed url="http://dronesec.pw/blog/2019/08/12/code-execution-via-fiber-local-storage/" caption="" %}
